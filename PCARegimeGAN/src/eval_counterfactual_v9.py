...
def main():
    ...
    # SF-MarketGAN-R
    gen, cfg = load_v9(args.ckpt, n_assets, n_factors, d_cov, L_eps, device)
    f_in = f_arr
    ...
    from eval_v9 import gen_paths_v9_like
    v9_paths = gen_paths_v9_like(gen, cov_arr, f_in, alpha_hat, beta_hat, sigma_hat,
